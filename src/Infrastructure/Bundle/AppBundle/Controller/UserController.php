...
//
//use Infrastructure\Bundle\AppBundle\Entity\User;
...
//    {
//        $user = new User();
//        $form = $this->createForm('Infrastructure\Bundle\AppBundle\Form\UserType', $user);
...
//    {
//        $deleteForm = $this->createDeleteForm($user);
//        $editForm = $this->createForm('Infrastructure\Bundle\AppBundle\Form\UserType', $user);
